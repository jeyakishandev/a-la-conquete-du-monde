...
const articles = [
  ...
  },
  {
    ...
    description:
      "Visiter New York en 3 jours, c'est possible ! Découvrez notre itinéraire optimisé pour ne rien manquer des incontournables de la Big Apple : Times Square, Central Park, la Statue de la Liberté et bien plus encore.",
    content:
      "New York en 3 jours nécessite une organisation parfaite. Jour 1 : commencez par Times Square et Broadway, puis direction Central Park pour une pause nature. Le soir, montez au sommet de l'Empire State Building pour une vue imprenable. Jour 2 : prenez le ferry vers la Statue de la Liberté et Ellis Island, puis explorez le Financial District et le 9/11 Memorial. Jour 3 : consacrez la matinée à Brooklyn Bridge et DUMBO, puis passez l'après-midi à SoHo et Greenwich Village. Le soir, profitez de l'ambiance de Times Square illuminée.",
    category: 'culture',
  ...
  },
  {
    ...
    description:
      "L'Islande, terre de feu et de glace, se découvre idéalement en road-trip. Découvrez notre itinéraire de 10 jours pour explorer les plus beaux sites de cette île nordique unique au monde.",
    content:
  ...
  },
  {
    ...
    description:
      'Chicago, la ville des vents, séduit par son architecture remarquable, sa scène culturelle dynamique et sa gastronomie réputée. Découvrez les incontournables de cette métropole du Midwest américain.',
    content:
  ...
  },
  {
    ...
    description:
      'Découvrez Paris, la capitale française aux mille facettes. De la Tour Eiffel au Louvre, en passant par les Champs-Élysées et Montmartre, explorez tous les incontournables de la plus belle ville du monde.',
    content:
  ...
  },
  {
    ...
    description:
      "Tokyo, métropole futuriste où se mêlent tradition et modernité. Explorez Shibuya, les temples historiques, les marchés et découvrez l'incroyable effervescence de cette mégapole unique.",
    content:
      "Tokyo est une ville de contrastes saisissants. Shibuya Crossing, le carrefour le plus fréquenté au monde, symbolise le rythme effréné de la ville. Le temple Senso-ji à Asakusa offre un moment de sérénité dans le cœur historique. Le marché aux poissons de Tsukiji, bien que déménagé, reste une expérience culinaire inoubliable. Harajuku est le quartier de la mode alternative et de la culture kawaii. Shinjuku abrite le plus grand quartier de divertissement au monde. Les jardins impériaux offrent une oasis de verdure en plein cœur de la ville. La cuisine japonaise, des sushis aux ramens en passant par les izakayas, est une expérience gustative exceptionnelle. Les onsens, bains thermaux traditionnels, permettent de se détendre après une journée d'exploration. Ne manquez pas une visite au mont Fuji, visible depuis Tokyo par beau temps.",
    category: 'destinations',
    image: 'assets/images/New-york.jpg',
  },
  {
  ...
  },
  {
    ...
    description:
      "Dubai, ville ultramoderne aux gratte-ciels futuristes et îles artificielles. Découvrez Burj Khalifa, Palm Jumeirah, les centres commerciaux et l'opulence émiratie.",
    content:
