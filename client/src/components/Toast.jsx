...
export default function Toast({ message, type = 'info', onClose, duration = 5000 }) {
  ...
  return (
    <div
      className={`px-6 py-4 rounded-lg shadow-xl border ${bgColor[type]} animate-slide-in-right max-w-md`}
    >
      <div className="flex items-center justify-between gap-4">
        ...
        <button onClick={onClose} className="text-lg hover:opacity-70 transition">
          <FaTimes />
        </button>
      </div>
    </div>
