...
export default function Footer({ darkMode }) {
  ...
  return (
    <footer
      className={`relative mt-20 pt-12 pb-8 ${
        darkMode
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12 mb-8 sm:mb-12">
          ...
          <div className="space-y-4">
            ...
            >
              ...
              authentiques, conseils pratiques et guides détaillés pour transformer vos rêves de
              voyage en réalité.
            </p>
            <div className="flex items-center gap-3 pt-2">
              <FaCompass
                className={`text-orange-500 animate-spin-slow ${darkMode ? 'opacity-80' : ''}`}
              />
          ...
          <div>
            <h4 className={`font-bold text-base mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>
              Navigation
            </h4>
          ...
          <div className="min-w-0">
            ...
            >
              Restez informé de nos dernières aventures, conseils de voyage exclusifs et offres
              spéciales. Rejoignez notre communauté de voyageurs passionnés !
            </p>
            <form onSubmit={handleNewsletterSubmit} className="space-y-2 sm:space-y-3">
              ...
              <p className={`text-xs mt-2 ${darkMode ? 'text-gray-500' : 'text-gray-500'}`}>
                En vous abonnant, vous acceptez de recevoir nos emails. Vous pouvez vous désabonner
                à tout moment.
              </p>
            </form>
          </div>
        ...
        {/* Séparateur */}
        <div className={`h-px w-full my-8 ${darkMode ? 'bg-gray-700/50' : 'bg-gray-300/50'}`}></div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          >
            ...
            <p className="text-xs">
              Fait avec <FaHeart className="inline text-red-500 animate-pulse" /> par des passionnés
              de voyage
            </p>
          </div>
