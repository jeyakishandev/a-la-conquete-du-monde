        ...
        <section className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl sm:rounded-[3rem] p-6 sm:p-8 lg:p-12 shadow-2xl border border-white/50 dark:border-gray-700/50 relative overflow-hidden mb-8 sm:mb-12">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
              Depuis notre création, nous nous efforçons de partager notre passion pour le voyage et
              de vous inspirer à découvrir les merveilles du monde. Notre mission est de vous
              accompagner dans vos aventures, que vous soyez un voyageur expérimenté ou que vous
              débutiez dans l'art du voyage.
            </p>
            <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
              Nous croyons que chaque voyage est une opportunité d'apprendre, de grandir et de créer
              des souvenirs inoubliables. C'est pourquoi nous nous engageons à vous fournir des
              conseils pratiques, des récits authentiques et des informations précieuses pour rendre
              vos voyages exceptionnels.
            </p>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="group text-center bg-gradient-to-br from-white to-orange-50/50 dark:from-gray-700/50 dark:to-gray-600/50 rounded-3xl p-6 sm:p-8 hover:scale-105 transition-all duration-300 shadow-lg">
                ...
                <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 leading-relaxed">
                  Passionné de voyage depuis plus de 10 ans, Alexandre a visité plus de 50 pays. Il
                  partage ses expériences et conseils pour vous aider à organiser vos prochains
                  voyages.
                </p>
              </div>
              <div className="group text-center bg-gradient-to-br from-white to-blue-50/50 dark:from-gray-700/50 dark:to-gray-600/50 rounded-3xl p-6 sm:p-8 hover:scale-105 transition-all duration-300 shadow-lg">
                ...
                <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 leading-relaxed">
                  Sophie capture la beauté du monde à travers son objectif. Ses photos et récits
                  vous transportent dans les plus beaux endroits de la planète.
                </p>
              </div>
            </div>
          </div>
